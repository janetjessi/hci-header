    ...
    <div
      className={`transition-all duration-800 ease-in-out transform ${
        isDropdownOpen
          ...
          : "-translate-y-10 opacity-0 -z-10 invisible"
      } absolute top-[70px] bg-white shadow-lg border z-50 w-full mx-auto pt-10 pb-14 left-0`}
    >
      {children}
    </div>
  );
                        ...
                        <div className="max-h-[calc(100vh-60px)] overflow-y-auto">
                          <div>
                            ...
                            <div className="bg-white mx-[20px]">
                              <ul className="flex flex-col text-mediumGrey text-base">
                                {pgCourses.map((pg) => (
                                  <li className="py-[10px]" key={pg}>
                                    <a
                                      href="#"
                                      className="text-medium hover:text-blue-600"
                                    >
                                      {pg}
                                    </a>
                                  </li>
                          ...
                          <div>
                            ...
                            <div className="bg-white mx-[20px]">
                              <ul className="flex flex-col text-mediumGrey text-base">
                                {ugCourses.map((ug) => (
                                  <li className="py-[10px]" key={ug}>
                                    <a
                                      href="#"
                                      className="flex gap-[15px] items-center text-medium hover:text-blue-600"
                                    >
                                      <div>
                                        <Image
                                          src={"/uk_destination.png"}
                                          alt="headerLogo"
                                          width={30}
                                          height={30}
                                      ...
                                      <div className="flex gap-[10px] items-center w-full border-b border-greyBorder min-h-[40px] flex-1 leading-[16px]">
                                        {" "}
                                        {ug}
                                      </div>
                                    </a>
                              ...
                              <ul className="flex flex-col text-mediumGrey text-base">
                                {ugCourses.map((ug) => (
                                  <li className="py-[10px]" key={ug}>
                                    <a
                                      href="#"
                                      className="flex gap-[15px] items-center text-para hover:text-blue-600"
                                    >
                                      <div>
                                        <Image
                                          src={"/usa_destination.png"}
                                          alt="headerLogo"
                                          width={30}
                                          height={30}
                                          className="rounded-[50%]"
                                      ...
                                      <div className="flex gap-[10px] items-center w-full border-b border-greyBorder min-h-[42px] flex-1 leading-[16px]">
                                        {" "}
                                        {ug}
                                      </div>
                                    </a>
          ...
          <div className="hidden xl:flex">
            ...
            <div className="flex gap-1">
              ...
              <Dropdown isDropdownOpen={openDropdown === "courses"}>
                <div className="grid grid-cols-4 max-w-[1140px] mx-auto">
                  <div className="col-span-1 border-r border-lightestGrey px-[30px]">
                    ...
                    <div>
                      ...
                      <ul className="flex flex-col text-mediumGrey text-base">
                        {pgCourses.map((pg) => (
                          <li key={pg} className="py-[5px]">
                            <a
                              href="#"
                              className="text-para hover:text-blue-600 w-full inline-block"
                            >
                              {" "}
                              {pg}
                            </a>
                        ...
                        {/* <li>
                            <div className="flex gap-[10px] group cursor-pointer hover:underline hover:rounded hover:decoration-ctaBlue hover:bg-hoverGrey transition-all py-3 ps-2">
                              <span className="text-ctaBlue hover:text-ctaHoverBlue">
                                Explore all
                              </span>
                              <div className="ms-0 transition-all group-hover:ms-1">
                        ...
                        {ugCourses.map((ug) => (
                          <li className="py-[8px]" key={ug}>
                            <a
                              ...
                              className="flex gap-[15px] items-center text-para hover:text-blue-600"
                            >
                              <div className="rounded-[50%] p-[2px] border border-greyBorder">
                                <Image
                                  src={"/uk_destination.png"}
                                  alt="headerLogo"
                                  width={30}
                ...
                <div className="grid grid-cols-[3fr_1fr] gap-5 max-w-[980px] mx-auto">
                  ...
                  <div className=" flex flex-col gap-4">
                    <div>
                      ...
                      <ul className="flex flex-col text-mediumGrey">
                        {["Study in Malaysia", "Study in Singapore"].map(
                          (destination) => (
                            <li
                              key={destination}
                              className="p-2 hover:bg-hoverGrey hover:text-darkGrey transition-all rounded text-para"
                            >
                              {destination}
                            </li>
                          )
                    ...
                    <div className="flex items-center gap-[10px] group cursor-pointer hover:underline hover:decoration-ctaBlue hover:bg-hoverGrey hover:rounded transition-all p-2 text-para">
                      <span className="text-ctaBlue hover:text-ctaHoverBlue">
            ...
            <div className="flex gap-1">
              ...
              >
                ...
                <div
                  className={`py-[25px] transform transition-transform durgit add README.md
